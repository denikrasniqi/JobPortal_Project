using Job_Portal.App.Implementations;
...
builder.Services.AddTransient<IPostJobRepository, PostJobRepositosy>();
builder.Services.AddTransient<IJobTypeRepository, JobTypeRepositosy>();
